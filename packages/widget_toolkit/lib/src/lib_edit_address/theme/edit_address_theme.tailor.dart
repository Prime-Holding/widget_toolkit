...
mixin _$EditAddressThemeTailorMixin on ThemeExtension<EditAddressTheme> {
  double get spacingM;
  double get spacingXSS;
  double get spacingXS;
  double get editAddressWidgetSpacingXS;
  double get addressWidgetSpacingXS;
  double get spacingS;
  double get spacingL;
  ...
  @override
  EditAddressTheme lerp(
      covariant ThemeExtension<EditAddressTheme>? other, double t) {
    if (other is! EditAddressTheme) return this as EditAddressTheme;
    return EditAddressTheme(
