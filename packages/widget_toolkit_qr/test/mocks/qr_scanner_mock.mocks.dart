...
class _FakeConnectableStream_0<T1> extends _i1.SmartFake
    implements _i2.ConnectableStream<T1> {
...
class _FakeQrScannerBlocStates_2<T1> extends _i1.SmartFake
    implements _i3.QrScannerBlocStates<T1> {
