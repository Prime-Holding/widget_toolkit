...
mixin _$PinCodeThemeTailorMixin on ThemeExtension<PinCodeTheme> {
  ...
  double get spacing5;
  double get spacing6;
  Widget get pinDeleteActionIcon;
  Widget get pinDeleteDefaultIcon;
  Widget get faceScanDefaultIcon;
  Widget get faceScanInvertedIcon;
  Widget get faceScanPressedIcon;
  Widget get fingerScanDefaultIcon;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(transparentColor, other.transparentColor) &&
            const DeepCollectionEquality().equals(
            ...
            const DeepCollectionEquality()
                .equals(shimmerBaseColor, other.shimmerBaseColor) &&
            const DeepCollectionEquality()
            ...
            const DeepCollectionEquality().equals(
                ...
                other.pinKeyboardMaskedKeyBorderColor) &&
            const DeepCollectionEquality().equals(
                pinKeyboardMaskedKeyColor, other.pinKeyboardMaskedKeyColor) &&
            const DeepCollectionEquality().equals(
            ...
            const DeepCollectionEquality()
                .equals(subtitleBold, other.subtitleBold) &&
            const DeepCollectionEquality()
