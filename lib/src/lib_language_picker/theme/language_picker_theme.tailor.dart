...
class LanguagePickerTheme extends ThemeExtension<LanguagePickerTheme> {
  ...
  static final LanguagePickerTheme light = LanguagePickerTheme(
    ...
    appFilledButtonTextColorDisabled:
        _$LanguagePickerTheme.appFilledButtonTextColorDisabled[0],
    ...
    appOutlineButtonBackgroundColor:
        _$LanguagePickerTheme.appOutlineButtonBackgroundColor[0],
  ...
  static final LanguagePickerTheme dark = LanguagePickerTheme(
    ...
    appFilledButtonTextColorDisabled:
        _$LanguagePickerTheme.appFilledButtonTextColorDisabled[1],
    ...
    appOutlineButtonBackgroundColor:
        _$LanguagePickerTheme.appOutlineButtonBackgroundColor[1],
  ...
  LanguagePickerTheme lerp(
      ThemeExtension<LanguagePickerTheme>? other, double t) {
    if (other is! LanguagePickerTheme) return this;
    return LanguagePickerTheme(
      changeLanguagePadding:
